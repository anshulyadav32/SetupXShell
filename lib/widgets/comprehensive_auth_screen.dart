...
class ComprehensiveAuthScreen extends StatefulWidget {
  const ComprehensiveAuthScreen({super.key});

  @override
  State<ComprehensiveAuthScreen> createState() => _ComprehensiveAuthScreenState();
}

class _ComprehensiveAuthScreenState extends State<ComprehensiveAuthScreen>
  ...
  // String _selectedCountry = 'US'; // Removed unused variable
    ...
    showCountryPicker(
      ...
      onSelect: (country) {
        setState(() {
          ...
          // _selectedCountry = country.countryCode; // Removed unused assignment
        });
      },
    );
  }
