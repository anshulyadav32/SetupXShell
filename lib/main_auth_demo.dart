...
class AuthDemoWrapper extends StatelessWidget {
  const AuthDemoWrapper({super.key});
  ...
  Future<void> _verifyPhoneOtp() async {
    ...
    if (_otpController.text == '123456') {
      await authService.signInWithEmailAndPassword(
        '${_phoneController.text}@phone.com',
        'password123',
      );
    } else if (mounted) {
